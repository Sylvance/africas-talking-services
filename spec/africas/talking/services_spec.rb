...
RSpec.describe Africas::Talking::Services do
  ...
  describe "Africas::Talking::Services::Voice class" do
    ...
    context "when doing a voice call api call" do
      let(:entity) do
    ...
    context "when doing a voice say api call" do
      let(:entity) do
    ...
    context "when doing a voice play api call" do
      let(:entity) do
    ...
    context "when doing a voice get_digits api call" do
      let(:entity) do
    ...
    context "when doing a voice forward_call api call" do
      let(:entity) do
    ...
    context "when doing a voice record api call" do
      let(:entity) do
    ...
    context "when doing a voice terminal_record api call" do
      let(:entity) do
    ...
    context "when doing a voice enqueue api call" do
      let(:entity) do
    ...
    context "when doing a voice dequeue api call" do
      let(:entity) do
    ...
    context "when doing a voice redirect api call" do
      let(:entity) do
